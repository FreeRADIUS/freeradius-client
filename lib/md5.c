...
static void MD5Update(MD5_CTX *context, const void *in, unsigned int inputLen);
...
{
	unsigned int i;
	const UINT4 *ip = (const UINT4 *)input;
...
void
rc_md5_calc(unsigned char *output, unsigned char *input, unsigned int inlen)
{
	MD5_CTX context;
